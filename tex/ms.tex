...
%%----------------------------------------------------------------------
\section{Building the Parent Sample}
\label{sec:parent}
%%----------------------------------------------------------------------
...
\input{tables/table-parent-vicuts.tex}
...
\input{tables/table-parent-archive.tex}
...
\input{tables/table-gaia-mask-params.tex}
...
full, corrected catalog, excluding \texttt{RESOLVED} and
\texttt{FORCEPSF} objects (which we instead assign to singleton
groups), harmonize region bits within each resulting group, and set the
\texttt{OVERLAP} sample bit for groups that straddle both imaging
regions.  For the final several releases, we additionally exempt any
...
\input{tables/table-parent-overlays.tex}
...
\input{tables/table-sample-bitmask.tex}
\input{tables/table-ellipsemode-bitmask.tex}
\input{tables/table-ellipsebit-bitmask.tex}
\input{tables/table-maskbits.tex}
